              ...
              <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
                {employee.handoverDetails && (
                  ...
                  <div className="text-center py-8">
                    <i className="fas fa-handshake text-4xl text-blue-300 mb-4"></i>
                    <p className="text-blue-600 font-medium mb-2">No Handover Details Available</p>
                    <p className="text-blue-500 text-sm">
                      Handover details will appear here once the employee handover process is completed.
                    </p>
                  </div>
                )}
              </div>
